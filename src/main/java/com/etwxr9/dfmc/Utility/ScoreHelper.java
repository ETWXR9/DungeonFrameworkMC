package com.etwxr9.dfmc.Utility;
...
public class ScoreHelper {
    ...
    private ScoreHelper(Player player) {
        ...
        sidebar = scoreboard.registerNewObjective("sidebar", "dummy", "default");
    ...
    public void setSlotsFromLuaTable(LuaTable table) {
        var list = new ArrayList<String>();
        for (int i = 0; i < table.length(); i++) {
            LuaValue luaValue = table.get(i + 1);
            if (luaValue.typename() == "string") {
                list.add(luaValue.tojstring());
            }
        }
